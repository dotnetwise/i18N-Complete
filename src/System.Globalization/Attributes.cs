    ...
    : System.ComponentModel.DisplayNameAttribute
{
    ...
    /// <param name="name">The displayName text to be localized</param>
    ...
    #region Properties
    /// <summary>
    /// Returns the non-localized DisplayName key so you can translate it on your own
    /// </summary>
...
public class PlaceHolderAttribute
    : DisplayNameAttribute, IMetadataAware
{
    /// <summary>Creates a new instance of PlaceHolderAttribute</summary>
    /// <param name="placeholder">The placeholder text to be translated</param>
    /// <param name="args">Custom extra arguments to format the placeholder message with</param>
    /// <created author="laurentiu.macovei" date="Sat, 07 Jan 2012 03:15:06 GMT"/>
    public PlaceHolderAttribute(string placeholder, params object[] args)
        : base(placeholder, args)
    {
    }
    ...
    {
        if (DisplayName != null)
            metadata.AdditionalValues["placeholder"] = DisplayName;
    }
}