	...
	public static partial class I18N
	{
		...
		public static string _s(this CultureInfo culture, string singular, string plural, int count, params object[] arguments)
		{
			return
				...
				? string.Format(count == 1 ? Internationalization.GetText(singular, lcid: culture.LCID) : Internationalization.GetText(singular, plural: true, lcid: culture.LCID), count)
				: string.Format(count == 1 ? Internationalization.GetText(singular, lcid: culture.LCID) : Internationalization.GetText(singular, plural: true, lcid: culture.LCID), new object[] { count }.Concat(arguments).ToArray());
		}
		/// <summary>
		...
		public static MvcHtmlString __s(this CultureInfo culture, string singularHTML, string pluralHTML, int count, params object[] arguments)
		{
			return new MvcHtmlString(
				(arguments == null || arguments.Length == 0)
				? string.Format(count == 1 ? Internationalization.GetText(singularHTML, lcid: culture.LCID) : Internationalization.GetText(singularHTML, plural: true, lcid: culture.LCID), count)
				: string.Format(count == 1 ? Internationalization.GetText(singularHTML, lcid: culture.LCID) : Internationalization.GetText(singularHTML, plural: true, lcid: culture.LCID), new object[] { count }.Concat(arguments.Select(a => HttpUtility.HtmlEncode(a))).ToArray()));
		}
		/// <summary>
		...
		public static MvcHtmlString ___s(this CultureInfo culture, string singularHTML, string pluralHTML, int count, params object[] htmlArguments)
		{
			return new MvcHtmlString(
				...
				? string.Format(count == 1 ? Internationalization.GetText(singularHTML, lcid: culture.LCID) : Internationalization.GetText(singularHTML, plural: true, lcid: culture.LCID), count)
				: string.Format(count == 1 ? Internationalization.GetText(singularHTML, lcid: culture.LCID) : Internationalization.GetText(singularHTML, plural: true, lcid: culture.LCID), new object[] { count }.Concat(htmlArguments).ToArray()));
		}
		/// <summary>
		...
		public static MvcHtmlString ___s(this CultureInfo culture, string singular, string plural, int count, Func<object, string> escapeArgumentFunc, params object[] arguments)
		{
			return new MvcHtmlString(
				(arguments == null || arguments.Length == 0)
				? string.Format(count == 1 ? escapeArgumentFunc(Internationalization.GetText(singular, lcid: culture.LCID)) : escapeArgumentFunc(Internationalization.GetText(singular, plural: true, lcid: culture.LCID)), escapeArgumentFunc(count))
				: string.Format(count == 1 ? escapeArgumentFunc(Internationalization.GetText(singular, lcid: culture.LCID)) : escapeArgumentFunc(Internationalization.GetText(singular, plural: true, lcid: culture.LCID)),
