...
namespace System.Web.Mvc
{
		...
		: WebViewPage
	{
		...
		public static MvcHtmlString __q(string text, params object[] arguments)
		{
			return new MvcHtmlString('"' + HttpUtility.HtmlAttributeEncode(string.Format(Internationalization.GetText(text), arguments.Select(a => HttpUtility.HtmlEncode(a)).ToArray())) + '"');
		}
		/// <summary>
		/// 	<para>Quotes the text as the xgettext cannot correctly extract values from attributes</para>
