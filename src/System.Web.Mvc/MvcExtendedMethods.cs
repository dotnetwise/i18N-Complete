...
namespace System.Web.Mvc
{
	...
	public static class MvcExtendedMethods
	{
		...
		{
			return htmlHelper.ActionLink(linkText, actionName, controllerName, new RouteValueDictionary { { "Area", area } }, null);
		}
		...
		{
			return htmlHelper.ActionLink(linkText, actionName, controllerName, htmlAttributes: HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes), routeValues: new RouteValueDictionary(routeValues) { { "area", area } });
		}
		...
		{
			return htmlHelper.ActionLink(linkText, actionName, controllerName, htmlAttributes: htmlAttributes, routeValues: new RouteValueDictionary(routeValues) { { "area", area } });
		}
		...
		{
			return url.Action(actionName, controllerName, new RouteValueDictionary(routeValues) { { "area", area } });
		}
		...
		{
			return url.Action(actionName, controllerName, new RouteValueDictionary(routeValues) { { "area", area } }, protocol);
		}
