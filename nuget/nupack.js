...
asyncblock(function (flow) {
	...
	nuspecFiles.forEach(function (input) {
		...
		var output = path.normalize(path.join(path.dirname(input), "build."+ path.basename(input))), content;
		fs.writeFileSync(output, content);
		process.cwd(path.dirname(input));
		console.warn("nuget", "pack", output);
